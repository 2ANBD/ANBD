...
import { FacebookFilled, TwitterOutlined, InstagramOutlined, YoutubeOutlined } from "@ant-design/icons";
      ...
      <footer>
        <div id="container">
          <motion.div variants={list} initial="hidden" animate="visible" className="inner">
            ...
            <motion.p variants={item} className="copyright">
              Copyrightⓒ ANBD Inc. All rights reserved.
            </motion.p>
          </motion.div>
        </div>
      </footer>
