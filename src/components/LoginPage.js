...
function LoginPage() {
  ...
  const NAVER_AUTH_URL = "https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=Le9ywWBU613n5i0TBz2U&redirect_uri=http://anbd.vercel.app&response_type=code";
  const list = {
    hidden: {
      opacity: 0,
    },
