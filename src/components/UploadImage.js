        ...
        <div id="container">
          ...
          <div className="inner">
            <Form name="uploadForm" onFinish={onFinish}>
              <Form.Item label={<span className="upload-label">상품 이미지</span>} name="product-name" rules={[{ required: true, message: "상품 이미지는 필수 입력 사항입니다." }]}></Form.Item>
              ...
              <Modal open={previewOpen} title={previewTitle} footer={null} onCancel={handleCancel}></Modal>
              <Divider />
              <Form.Item label={<span className="upload-label">상품 브랜드</span>} name="product-name" rules={[{ required: true, message: "상품 브랜드는 필수 입력 사항입니다." }]}>
                <Input className="upload-name" placeholder="상품 브랜드를 입력해주세요" size="large" />
              </Form.Item>
              <Divider />
              <Form.Item label={<span className="upload-label">상품 카테고리</span>} name="Category" rules={[{ required: true, message: "상품 카테고리는 필수 선택 사항입니다." }]}></Form.Item>
